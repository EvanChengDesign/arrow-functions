...
// "This" refers to the instance of `student` that `joe` points to. Since `scope` is called as a method of `joe`, `this` within `scope` refers to `joe`.
// 2. What is "this" when joe.scopeArrow() is invoked?
// "This" in the arrow function captures the `this` value of the enclosing execution context.  
// 3. Explain why "this" is different when an arrow function is used.
// Arrow functions capture the `this` value of the enclosing execution context at the time they are created, rather than than binding their own `this` context when they are called. arrow functions is designed to provide more predictable behavior of this, especially in scenarios where functions are used as callbacks or within functional programming patterns. 
